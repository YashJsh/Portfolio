            ...
            <div className="flex flex-col items-center gap-2 mt-2">
                ...
                <div className="flex items-center gap-4 text-muted-foreground/50">
                    <button 
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 border border-dashed border-border/80 rounded-lg bg-background hover:bg-muted/50 hover:border-foreground/50 transition-colors text-foreground shadow-sm cursor-pointer"
                    >
