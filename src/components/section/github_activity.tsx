...
export function GithubActivity() {
  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <div className="border border-dashed border-border rounded-xl p-3 sm:p-6 bg-background overflow-x-auto shadow-sm w-full">
        <div className="w-max min-w-full flex justify-start sm:justify-center">
          <GitHubCalendar
